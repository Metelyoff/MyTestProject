...
public class IntegerGenerator {
	...
	/**
	 * Generate <b>count</b> numbers between <b>min</b> and <b>max</b>
	 * inclusively. Similar behavior to Arrays.shuffle().
	 * 
	 * @param min
	 * @param max
	 * @param count
	...
	public ArrayList<Integer> generate(int min, int max, int count) throws IOException {
		String query = INTEGER_QUERY + INT_MIN + min + INT_MAX + max + INT_NUM + count + INT_BASE + BASE + INT_COL
				+ COLS;
