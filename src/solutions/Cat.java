...
public class Cat {
	...
	public boolean fight(Cat anotherCat) {
		...
		if (anotherCat instanceof Cat) {
			...
			if (((Cat) anotherCat).getAge() > 5 && ((Cat) anotherCat).getAge() < 20
					&& ((Cat) anotherCat).getAge() > this.age) {
				anotherStrength += 1;
			...
			/*
			 * if(this.weight>((Cat)anotherCat).getWeight()){ this.strength+=1;
			 * }else{ if(this.weight==((Cat)anotherCat).getWeight()){
			 * if(this.age>5&&this.age<20&&this.age>((Cat)anotherCat).getAge()){
			 * this.strength+=1; }
			 * if(((Cat)anotherCat).getAge()>5&&((Cat)anotherCat).getAge()<20&&(
			 * (Cat)anotherCat).getAge()>this.age){ anotherStrength+=1;
			 * ((Cat)anotherCat).setStrength(anotherStrength); } }else{
			 * anotherStrength+=1;
			 * ((Cat)anotherCat).setStrength(anotherStrength); } }
			 */
			 ...
			 * this.strength+=1; }
			 * if(((Cat)anotherCat).getAge()>5&&((Cat)anotherCat).getAge()<20&&(
			 * (Cat)anotherCat).getAge()>this.age){ int
			 * aStrength=((Cat)anotherCat).getStrength()+1;
			 * ((Cat)anotherCat).setStrength(aStrength); }
			 */
			/*
			 * if(this.age>((Cat)anotherCat).getAge()){ this.strength+=1; }else{
